...
public class AutoTests extends NarwhalRobot {
    ...
    protected void constructHardware() {
        ...
        waypoints.add(new Pose2D(173*Constants.inchesToMeters, 196*Constants.inchesToMeters, Rotation2D.fromDegrees(90)));
        waypoints.add(new Pose2D(150*Constants.inchesToMeters, 230.59*Constants.inchesToMeters, Rotation2D.fromDegrees(180)));
        waypoints.add(new Pose2D(70*Constants.inchesToMeters, 270.59*Constants.inchesToMeters, Rotation2D.fromDegrees(90)));
        waypoints.add(new Pose2D(136.63*Constants.inchesToMeters, 297.5*Constants.inchesToMeters, Rotation2D.fromDegrees(0)));
        waypoints.add(new Pose2D(372.63*Constants.inchesToMeters, 297.5*Constants.inchesToMeters, Rotation2D.fromDegrees(0)));
